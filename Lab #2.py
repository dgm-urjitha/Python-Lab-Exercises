#!/usr/bin/env python3
#Lab-2 Lakshmi Urjitha Dhadigam
...
def display_menu():
    ...
    print("find_by_year - Find movies by year")
    print("find_by_name-Find movies by name")
...
def main():
    ...
    while True:        
        ...
        if command.lower() == "list":
            ...
            delete(movie_list)
        elif command.lower() == "find_by_year":
            find_by_year(movie_list)
        elif command.lower() == "find_by_name":
            find_by_name(movie_list)
